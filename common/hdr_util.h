...
// Returns VP9 profile in |profile| or -1 if there was no profile set in
// CodecPrivate data. Returns VP9 level in |level| or -1 if there was no level
// set in CodecPrivate data.
