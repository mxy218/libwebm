...
const Vp9LevelRow Vp9LevelStats::Vp9LevelTable[kNumVp9Levels] = {
    ...
    // CPB Size = 0 for level 5_2 to 6_2
...
void Vp9LevelStats::AddFrame(const Vp9HeaderParser& parser, int64_t time_ns) {
  ...
  const int luma_picture_breadth = (width > height) ? width : height;
...
Vp9Level Vp9LevelStats::GetLevel() const {
  ...
  const int max_luma_picture_breadth = GetMaxLumaPictureBreadth();
...
int Vp9LevelStats::GetMaxLumaPictureBreadth() const {
