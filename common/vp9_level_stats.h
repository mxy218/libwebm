...
class Vp9LevelStats {
 public:
  ...
  Vp9LevelStats()
      : frames(0),
        ...
        max_luma_size_(0),
        max_luma_end_ns_(0),
        max_luma_sample_rate_grace_perecnt_(1.5),
        first_altref(true),
  ...
  double max_luma_sample_rate_grace_perecnt() const {
    return max_luma_sample_rate_grace_perecnt_;
  }
  void set_max_luma_sample_rate_grace_perecnt(double percent) {
    max_luma_sample_rate_grace_perecnt_ = percent;
  }
 ...
 private:
  ...
  double max_luma_sample_rate_grace_perecnt_;
