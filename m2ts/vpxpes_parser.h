...
#ifndef LIBWEBM_VPXPES_PARSER_H_
#define LIBWEBM_VPXPES_PARSER_H_
...
class VpxPesParser {
 public:
  ...
  // Parses the next packet in the PES. |header| and |frame| are optional out
  // parameters. Returns true when a packet is parsed successfully.
  bool ParseNextPesPacket(PesHeader* header, VpxFrame* frame);
...
#endif  // LIBWEBM_VPXPES_PARSER_H_
