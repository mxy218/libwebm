...
namespace {
// Copy the |src| string to |dst|.  The caller owns both the |src|
// string and the |dst| copy (hence the caller is responsible for
// eventually deallocating the strings).  Returns true if the source
// string was successfully copied to the destination.
