...
// compressed with zlip or header stripping.
...
class ContentEncoding {
 public:
  ...
  // Sets the content encrypeion id. Copies |length| bytes from |id| to
...
class Track {
 public:
  ...
  ContentEncoding* const GetContentEncodingByIndex(uint32 index) const;
