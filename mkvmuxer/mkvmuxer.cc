...
const float PrimaryChromaticity::kChromaticityMin = 0;
const float PrimaryChromaticity::kChromaticityMax = 1;
const float MasteringMetadata::kMinLuminance = 0;
const float MasteringMetadata::kMinLuminanceMax = 999.99;
const float MasteringMetadata::kMaxLuminanceMax = 9999.99;
...
bool MasteringMetadata::Valid() const {
  if (luminance_min_ != kValueNotPresent) {
    if (luminance_min_ < kMinLuminance || luminance_min_ > kMaxLuminanceMax)
      return false;
  }
