...
struct PrimaryChromaticity {
  ...
  ~PrimaryChromaticity() {}
  uint64_t PrimaryChromaticityPayloadSize(libwebm::MkvId x_id, libwebm::MkvId y_id) const;
  bool Write(IMkvWriter* writer, libwebm::MkvId x_id, libwebm::MkvId y_id) const;
