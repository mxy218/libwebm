...
uint64 WriteMetadata(IMkvWriter* writer,
  ...
  // Note that we don't write a reference time as part of the block group;
  // this indicates that this block is a keyframe.  (Unlike the case for
  // a SimpleBlock element, and the header bits of a Block sub-element of
  // the BlockGroup element do not indicate keyframe status.)
