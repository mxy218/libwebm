...
long Tracks::Parse()
{
    ...
    while (pos < stop)
    {
        ...
        const long long payload_size = ReadUInt(pReader, pos, len);
    ...
    Track*& pTrack) const
{
    ...
    while (pos < track_stop)
    {
        ...
        {
            delete[] i.codecNameAsUTF8;
            i.codecNameAsUTF8 = NULL;
    ...
    if ((i.type != 1) && (i.type != 2))  //known track type
    {
        i.Clear();
        return 0;  //no error
    }
    ...
    //TODO: propertly vet info.number, to ensure that it
    //is unique among all tracks.
    ...
    long& len)
{
    ...
    //if we see a track header in the tracks element with an supported
