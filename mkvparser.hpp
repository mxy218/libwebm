...
private:
    ...
    long CreateBlock(long long id, long long pos, long long size) const;
    long CreateBlockGroup(long long, long long) const;
    long CreateSimpleBlock(long long, long long) const;
