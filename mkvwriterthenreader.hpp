...
#ifndef MKVWRITERTHENREADER_HPP
#define MKVWRITERTHENREADER_HPP
...
// Default implementation of the IMkvWriterThenReader interface.
class MkvWriterThenReader : public IMkvWriterThenReader {
 public:
  MkvWriterThenReader();
  virtual ~MkvWriterThenReader();

  // IMkvWriterThenReader interface
  ...
  virtual int Length(int64* total, int64* available);
 ...
 private:
  ...
  LIBWEBM_DISALLOW_COPY_AND_ASSIGN(MkvWriterThenReader);
};

}  // end namespace mkvmuxer

#endif  // MKVWRITERTHENREADER_HPP
