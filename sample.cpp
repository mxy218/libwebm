...
int main(int argc, char* argv[]) {
  ...
  while (track_num != num_tracks) {
    ...
    if (trackType == mkvparser::Track::kVideo) {
      ...
      const mkvparser::Colour* colour = pVideoTrack->GetColour();
      if (colour) {
        printf("\t\tVideo Colour:\n");
