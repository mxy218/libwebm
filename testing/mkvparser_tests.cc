...
class ParserTest : public testing::Test {
 public:
  ...
  void CreateAndLoadSegmentNoHeaderChecks(const ::std::string& filename) {
    filename_ = GetTestFilePath(filename);
...
TEST_F(ParserTest, InvalidTruncatedChapterString) {
  CreateAndLoadSegmentNoHeaderChecks(
...
TEST_F(ParserTest, InvalidFixedLacingSize) {
  CreateAndLoadSegmentNoHeaderChecks("invalid/fixed_lacing_bad_lace_size.mkv");
