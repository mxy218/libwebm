...
// each metadata track.
void BuildMap(mkvparser::Segment* segment, metadata_map_t* metadata_map);
...
// if the write failed.
bool InitializeFiles(const metadata_map_t& metadat_map);
